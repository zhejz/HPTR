    ...
    def forward(
        ...
        for _ in range(inference_repeat_n):
            ...
            if self.decoder_k_reinforce_tl > 0:
                knn_idx_tl2self, knn_invalid_tl2self, _ = get_tgt_knn_idx(
                ...
                knn_idx_tl2map, knn_invalid_tl2map, _ = get_tgt_knn_idx(
            ...
            if self.decoder_k_reinforce_agent > 0:
                knn_idx_agent2self, knn_invalid_agent2self, _ = get_tgt_knn_idx(
                ...
                knn_idx_agent2maptl, knn_invalid_agent2maptl, _ = get_tgt_knn_idx(
            ...
            if self.decoder_k_reinforce_anchor:
                knn_idx_agent2all, knn_invalid_agent2all, _ = get_tgt_knn_idx(
            ...
            if self.decoder_k_reinforce_all > 0:
                knn_idx_all2all, knn_invalid_all2all, _ = get_tgt_knn_idx(
